    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Build the Music Brand of your Dreams</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Helping you Rouse Audience One Step at a Time.</h2>
          <div data-aos="fade-up" data-aos-delay="800">
            <a href="{{route('musics')}}" class="btn-get-started scrollto">Music Library</a>
            <a href="{{route('artists')}}" class="btn-get-started scrollto">Artists</a>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span style="color: white;" data-purecounter-start="0" data-purecounter-end="3" data-purecounter-duration="1" class="purecounter"></span>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span style="color: white;" data-purecounter-start="0" data-purecounter-end="9" data-purecounter-duration="1" class="purecounter"></span>
...
-->
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Store</h2>
          <p class="common-p">Collection you can find from limited edition lightsticks to fancy holograms</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Albums</li>
              <li data-filter=".filter-card">Clothing</li>
              <li data-filter=".filter-web">Gadgets and Other tools</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="/succesor/Tentacit Shape transparent-0.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Blank</h4>
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 2"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 1"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Blank</p>
                <div class="portfolio-links">
                  <a href="/succesor/Tentacit Shape transparent-0.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
