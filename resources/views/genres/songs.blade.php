                ...
                @foreach ($song as $song)
                    <div class="col-xs-12 col-sm-4">
                        <div class="card"  style="width: 20rem; ">
                            ...
                            <img src="/image/{{$song->background_image}}" />
                          </a>
...
<div id="song{{$song->id}}" class="modal">
  ...
  <div class="modal-content">   
    ...
    <div class="modal-body" style="background-image: url('/image/{{$song ->image}}');
    background-repeat:no-repeat;   background-size: cover;"  >
      <h2 class="song-titleh2" >{{$song ['songname']}}</h2>
      <h2 class="song-titleh2">{{$song ['author']}}</h2>

<img src="/image/{{$song ->background_image}}" style="width:300px; height:300px; margin-left:80px; border-radius:3px; border:solid;"  >
